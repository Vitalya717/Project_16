...
public class AviaSoulsTest {
    Ticket ticket1 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 11_500, 18, 21);
    Ticket ticket2 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 11_700, 9, 11);
    Ticket ticket3 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 10_900, 10, 11);
    Ticket ticket4 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 7_500, 15, 20);
    Ticket ticket5 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 8_500, 4, 8);
    Ticket ticket6 = new Ticket("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 7_500, 7, 11);
    ...
    public void sortingTicketsByDepartureAndArrivalAirports_1() {
        ...
        Ticket[] expected = {ticket4, ticket6, ticket5, ticket3, ticket1, ticket2};
        Ticket[] actual = avia.search("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void sortingTicketsByDepartureAndArrivalAirports_2() {
        ...
        Ticket[] expected = {};
        Ticket[] actual = avia.search("Сочи", "Саратов \"Гагарин\" ");
        Assertions.assertArrayEquals(expected, actual);
    }
    ...
    public void writeDownTheHashCode() {
        ...
        int expected = Objects.hash("Москва \"Домодедово\" ", "Саратов \"Гагарин\" ", 11_500, 18, 21);
